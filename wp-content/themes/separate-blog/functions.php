...
if ( ! function_exists( 'separate_blog_setup' ) ) :
	...
	function separate_blog_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'separate-blog' ),
 ...
 */
require get_template_directory() . '/classes/separate-blog-customizer.php';

/**
 * Walker menu
 */
require get_template_directory() . '/classes/separate-blog-walker-menu.php';

/**
 * Comment walker.
 */
require get_template_directory() . '/classes/separate-blog-comment-walker.php';
