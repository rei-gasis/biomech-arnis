...
function enqueue_arnis_style_page_css()
{
    ...
    wp_register_style( 'arnis-style-page-css', get_template_directory_uri() . '/assets/css/arnis-style-page.css', array(), '20190101', 'all' );
...
// include(WP_CONTENT_DIR . '\custom-shortcodes\test.php');
// add_shortcode( 'echotest', 'some_random_code' );